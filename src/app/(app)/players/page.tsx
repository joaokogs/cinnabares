...
import { PlayerCard } from "@/app/(public)/_components/players/player-card"
import { PlayerFilters } from "@/app/(public)/_components/players/player-filters"
import { PlayerPagination } from "@/app/(public)/_components/players/player-pagination"
  ...
  return (
    <main className="relative min-h-screen flex-1 overflow-hidden bg-background">
      ...
      <section className="relative mx-auto w-full max-w-7xl px-4 py-7 sm:px-6 lg:py-10">
        ...
        <PlayersResults result={result} hasFilters={hasFilters} query={query} guild={guild} status={status} />
      </section>
    </main>
  )
}
