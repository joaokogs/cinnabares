...
export function ProfileTabs({ overview, historico, posts }: ProfileTabsProps) {
  return (
    <Tabs defaultValue="principal" className="w-full">
      <TabsList aria-label="Seções do perfil" className="grid h-11 w-full grid-cols-3 rounded-xl bg-card/90 p-1 ring-1 ring-foreground/10">
