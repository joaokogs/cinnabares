...
export function TournamentForm() {
  ...
  async function submit(event: React.FormEvent<HTMLFormElement>) {
    ...
    setPending(true)
    setError(null)
    const result = await fetch("/api/tournaments", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ name, description, format, tiers: selectedTiers, tierRules, slots: Number(slots), visibility }) })
