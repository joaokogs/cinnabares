...
export function TournamentForm() {
  ...
  return <Card className="border-border/70 bg-card/90"><CardHeader><CardTitle>Configuração da chave</CardTitle></CardHeader><CardContent><form className="space-y-5" onSubmit={(event) => void submit(event)}>
